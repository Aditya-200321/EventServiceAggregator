...
<%
ServiceModel e = (ServiceModel) request.getAttribute("service");
...
<form action="<%=request.getContextPath()%>/UpdateServiceController"
      method="post"
      onsubmit="return validateService()" novalidate>

<input type="hidden"
       name="service_id"
       value="<%= e.getServiceId() %>">
...
<a class="back-link" href="viewService.jsp">
← Back
</a>
</div>
...
function validateService(){
    ...
    let name = document.getElementById("serviceName");
